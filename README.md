# Bias
My take on NixOS with a [Dendritic structure](https://github.com/mightyiam/dendritic) using [Flake Parts](https://flake.parts/) + [Home Manager](https://github.com/nix-community/home-manager).
